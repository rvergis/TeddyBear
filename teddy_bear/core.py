...
async def main():
    print("🧸 Teddy Bear using imagesnap (native Mac camera)")

    while True:
        print("Capturing image with imagesnap...")
        try:
            subprocess.run(["imagesnap", "-w", "1", "current.jpg"], check=True, stdout=subprocess.DEVNULL)
            print("✅ Image captured")
        except:
            print("❌ imagesnap failed")
